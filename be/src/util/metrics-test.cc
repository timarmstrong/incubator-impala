...
TEST_F(MetricsTest, PropertiesPrometheus) {
  MetricGroup metrics("Properties");
  AddMetricDef("property", TMetricKind::PROPERTY, TUnit::NONE);
  metrics.AddProperty("property", string("my value"));
  std::stringstream prop_val;
  metrics.ToPrometheus(true, &prop_val);
  AssertPrometheus(prop_val, "property", "0", "", "counter");
}

TEST_F(MetricsTest, PropertiesLineBreakPrometheus) {
  MetricGroup metrics("Properties");
  AddMetricDef("property", TMetricKind::PROPERTY, TUnit::NONE);
  metrics.AddProperty("property", string("my value\n new value \n"));
  std::stringstream prop_val;
